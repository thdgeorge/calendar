...
module.exports = function (sequelize, DataTypes) {
  var Company = sequelize.define(
    'Company',
    {
      ...
      timezone: {
        type: DataTypes.STRING, // ELEGENTO HACK - Change DataType to STRING
        allowNull: true,
      ...
      integration_api_token: {
        // ELEGENTO HACK - Change DataType to STRING
        type: DataTypes.STRING,
        allowNull: false,
        defaultValue: () => uuidv4(),
        comment: 'Indicate which mode the company account is in.',
    ...
    },
    {
      ...
      instanceMethods: {
        ...
        get_default_date_format_for_date_picker: function () {
          ...
          if (
            moment_to_datepicker_map.hasOwnProperty(
